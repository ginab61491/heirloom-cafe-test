        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start mb-16">
          ...
          <div>
            ...
            <div className="space-y-4 text-[var(--color-warm-gray)] leading-relaxed text-[15px]">
              <p>For more than sixteen years, Heirloom Caf&eacute; has been a neighborhood dining room in the heart of San Francisco&rsquo;s Mission District, a place built on the belief that exceptional food, mature wine, and genuine hospitality should feel both special and approachable.</p>
