...
export default async function EventsPage() {
  ...
  return (
    <div className="bg-[var(--color-cream)]">
      ...
      {/* Jump link — sits naturally below hero */}
      <div className="text-center py-5 border-b border-[var(--color-cream)]">
        <a href="#upcoming" className="inline-flex items-center gap-2 text-xs tracking-widest uppercase text-[var(--color-warm-gray)] hover:text-[var(--color-gold)] transition-colors">
          <span>Skip to Upcoming Events</span>
